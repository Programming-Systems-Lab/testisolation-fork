...
\todo{here we need to mention, each test suite in our
subject programs is designed to be executed in
a single JVM. In some projects, two tests may be required
to executed in two different processes by design, see~\cite{vmvm}.}
