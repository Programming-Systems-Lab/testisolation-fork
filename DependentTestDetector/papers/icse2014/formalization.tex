...
%\todo{the above examples are not so interesting. I would like to
%cut it.  replace it with one potential dependent test, and one manifest
%dependent test.}
...
\todo{I think the above definition of potential test dependence
is less motivated. It should be two tests whose execution may
affect each other's state, but does *not* manifest through
the oracle. The good part is that, using this definition, Definition 7
