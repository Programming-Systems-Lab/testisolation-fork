...
\todo{the name of f is bad, need to change}
...
\edit{SZ: I edited the following definition} 
...
\result{t}{S_1, \env_0}[$t$] $\neq$
\result{t}{S_2, \env_0}[$t$].
%
%${S_1 \subseteq T - t}$
...
\todo{still a point: why S1, S2? shouldnot S1 enough?}
