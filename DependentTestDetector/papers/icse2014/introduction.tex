...
Such conventional wisdom motivates us
...
test should initialize (or mock) the execution environment
and/or any resources it will use.
Likewise, after test execution, it should carefully reset the
...
Test dependence is usually caused by global variables shared by tests (Sections~\ref{sec:study}
...
Our study of \dtnum real-world, developer-confirmed dependent
tests 
