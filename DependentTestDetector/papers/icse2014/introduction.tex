...
\edit{I edited the following 3 paragraphs}
...
\item \textbf{Formalization.} We formalize test dependence
  ...
  to detect dependent tests (Section~\ref{sec:detecting}). The first \todo{use more descriptive termns}
  ...
  do not guarantee to find all dependent tests. \edit{check above when the algorithm section
      is written}
...
%%%%ignore text below, which is commented out
