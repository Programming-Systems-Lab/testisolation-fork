...
and collected \textit{all} papers~\cite{alltestprior} on test prioritization
...
(i.e., TOSEM and TSE) from the year 2000. Among the
23 collected papers, 
...
and only 1 paper acknowledged the potential dependences
between tests might affect the prioritization output~\cite{Kim:2002:HTP:581339.581357}. 
