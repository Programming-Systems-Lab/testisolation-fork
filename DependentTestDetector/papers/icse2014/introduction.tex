...
\edit{Please check the above paragraph. }
...
\todo{donot forget to recall above questions in the paper.}
...
\edit{I changed the subtitle, which was: Test Execution Environment}
...
\item \textbf{Formalization.} We formalize test dependence
  ...
  do not guarantee to find all dependent tests. \edit{check above}
