...
Further, we did a systematic literature survey
on \textit{all} test prioritization  papers\footnote{31 papers in total. The paper list is available at:~\cite{alltestprior}.} 
published on the research track of five major software engineering conferences
(i.e., ICSE, FSE, ISSTA, ASE, and ICST) and two major software engineering journals
(i.e., TOSEM and TSE) between 2000 and 2013.
27 papers explicitly or implicitly assumed test independence~\cite{alltestprior},
3 papers acknowledged the potential dependences between tests
