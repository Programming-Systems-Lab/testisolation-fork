...
For example, we did a systematic literature survey
and collected \textit{all} papers on
%proposing and evaluating
test prioritization 
(23 papers in total, paper list available at:~\cite{alltestprior}) 
published at five major software engineering conferences
(i.e., ICSE, FSE, ISSTA, ASE, and ICST) and two major software engineering journals
(i.e., TOSEM and TSE) from 2000 to 2013 (inclusive).
xxx papers explicitly or implicitly assumed test independence,
xxx papers considered violation of the test independence
assumption as a threat to validity,
and only 1 paper acknowledged (but did not evaluate whether)
the potential dependences between tests may affect the prioritization output~\cite{Kim:2002:HTP:581339.581357}. 
