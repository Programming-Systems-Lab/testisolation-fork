...
\item \textbf{Formalization.} We formalize test dependence
  ...
  In addition, we implemented five test prioritization
  techniques and evaluated them on the \subjnum subject programs
  that contain dependent tests. Our results show that all the
  five test prioritization techniques are affected by the dependent tests
