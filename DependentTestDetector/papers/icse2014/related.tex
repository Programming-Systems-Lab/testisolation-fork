...
Automated test generation techniques~\cite{PachecoLET2007, ZhangSBE2011} are also affected
...
\todo{not sure whether the following paragraph should be here?}
...
beyond the scope of any framework. \todo{Add Darioush's finding that
JUnit can support test dependence, but is not encouraged.}
