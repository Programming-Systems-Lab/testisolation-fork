...
(which are represented as partial orderings, such as one test should be executed before another) are known.
...
some database testing tools~\cite{kapfhammeretal:FSE:2003,
