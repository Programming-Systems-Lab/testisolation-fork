...
\todo{The above section may not be in the right place. It
should be grouped with sections with downstream applications.}
...
\todo{this section should be talking about the downstream apps, rather
than focusing on prioritization}
...
\todo{not finished. need to think about the implication}
...
%single setting of parameters A, B, C, D, E, F, G, H, we're hosed … but
