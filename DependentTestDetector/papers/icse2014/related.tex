...
heaps, files, etc.) before executing a test (or
generating a new test in a test generator~\cite{Csallner:2004}).
However, such an approach can be computationally expensive
and become less useful in practice, since a unit test is often small
