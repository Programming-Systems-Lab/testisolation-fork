...
Section~\ref{sec:heuristic} describes a heuristic algorithm
...
Figures~\ref{fig:heuristicalgorithm},~\ref{fig:randalgorithm},~\ref{fig:exhaustivealgorithm},
and~\ref{fig:impralg}.
}
...
\vspace{-3mm}
\caption {The heuristic algorithm to detect dependent tests.
...
Figure~\ref{fig:heuristicalgorithm} instantiates the
base algorithm (Figure~\ref{fig:basealgorithm}) for the
heuristic algorithm by reversing the original test execution
order.
