...
%tests. 
\edit{I add the following sentence}
Section~\ref{sec:randomized} describes a randomized algorithm
that repeatedly shuffles a test suite, and then
executes each test in a random order.
...
\edit{I add this following subsection}
