...
\edit{What about "Guided $k$-bounded algorithm"}
...
\todo{I did not edit text below, need to simplfiy the text}
...
are the same as lines 4--9 in Figure~\ref{fig:dtalgorithm}.
...
\todo{need to edit the text below}
...
\todo{discuss the soundness of the algorithm, which may be compromised
by class loading}
