...
When $k$=1, the algorithm first executes all tests in the default order
within the same JVM, and discards all tests that do \textit{not}
access (including read and write) any global fields. Then,
...
Figure~\ref{fig:impralg} shows the algorithm for $k$$\ge$2, which redefines
