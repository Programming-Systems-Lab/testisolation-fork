...
Figure~\ref{fig:basealgorithm} shows the base algorithm, and
...
In the case of $k\ge$2, the algorithm first runs the case of $k$=1
to find all dependent tests that can be manifested when executed in isolation,
...
The getPossibleExecOrder function first executes
