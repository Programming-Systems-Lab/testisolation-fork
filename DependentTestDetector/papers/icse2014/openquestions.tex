...
Reproducible examples, both from human-written test suites and
automatically generated test suites that we synthesized, show this in
six fielded, substantative, open-source systems.
%Reproducible examples from six fielded, substantive, open-source
%software systems demonstrate this with respect to both associated
%manually-created test suites and automatically generated test suites that we synthesized.  
This
``existence proof'' of test dependence is unlikely to surprise anyone,
nor does it suggest that test dependence is common
across \emph{all} software.  However, at least under our definition of
manifest test dependence, this question is closed.
...
We have also shown that, in principle, test dependence can compromise
...
dependence in test suites is NP-complete.  Our 
...
The
question of the role of test dependence in the real world merits
