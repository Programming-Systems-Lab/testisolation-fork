...
result than run in its default order.
...
because this test has side-effect on the database it reads.
We count this special case separately in the ``Self'' column
of Table~\ref{tab:studyresults}.

For remaining \unum dependent tests, the number of involved tests
...
The root cause for the remaining 23 (25\%) tests is not illustrated 
...
code that performs static variable initialization, to ensure that
