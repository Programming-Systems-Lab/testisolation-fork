...
in Table~\ref{tab:testprio} on the human-written test suites of
our subject programs. Each cell shows the number of dependent tests
...
happened in the evaluated subject programs, cause undesired output.
