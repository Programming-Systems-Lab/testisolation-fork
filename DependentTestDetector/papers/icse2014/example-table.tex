...
%\midrule
\cline{3-18}
\textbf{Programs} & \textbf{Tests} & \textbf{Heuristic} & \multicolumn{3}{|c|}{\textbf{Randomized}} & \multicolumn{2}{|c|}{\textbf{Exhaustive }} & \multicolumn{2}{|c|}{\textbf{Dep-Aware}} & \textbf{Heuristic}& \multicolumn{3}{|c|}{\textbf{Randomized}} & \multicolumn{2}{|c|}{\textbf{Exhaustive }} & \multicolumn{2}{|c|}{\textbf{Dep-Aware}} \\
...
\hline
\end{tabular}
\caption{Experimental results. \todo{I add a column for the heuristic algorithm} Column ``\#Tests'' shows the total number
