...
%\midrule
\cline{3-18}
\textbf{Programs} & \textbf{Tests} & \textbf{Heu} & \multicolumn{3}{|c|}{\textbf{Randomized}} & \multicolumn{2}{|c|}{\textbf{Exhaustive }} & \multicolumn{2}{|c|}{\textbf{Dep-Aware}} & \textbf{Heu}& \multicolumn{3}{|c|}{\textbf{Randomized}} & \multicolumn{2}{|c|}{\textbf{Exhaustive }} & \multicolumn{2}{|c|}{\textbf{Dep-Aware}} \\
...
Columns ``Heu'', ``Randomized'', ``Exhaustive'' and ``Dep-Aware'' show the results
of applying the heuristic algorithm, randomized algorithm, the exhaustive $k$-bounded algorithm, and the \dependenceaware{}, respectively.
