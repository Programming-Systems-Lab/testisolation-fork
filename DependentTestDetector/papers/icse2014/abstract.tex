\begin{abstract}
Test dependence arises when executing a test in different
orders among existing tests
%environments
...
First, we describe a study of \dtnum confirmed,
real-world dependent tests from \repnum
issue tracking systems to show that test dependence arises in practice.
Our study identifies common characteristics of
dependent tests, and shows that test dependence can have potentially costly
