...
Fifth, we implemented five test prioritization techniques
and evaluated them on the \subjnum programs containing
dependent tests. Our results suggest that \textit{all}
the five test prioritization techniques can be impacted by
dependent tests.
