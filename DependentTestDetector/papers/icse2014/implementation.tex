...
and clears external state such as files, ensuring there is no interaction between
...
\ourtool does not instrument JDK classes. It uses the side-effect annotations
...
instances) are stateless. Optionally, users can specify a
